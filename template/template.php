		...
		<header id="header" class="alt">
			...
			<nav id="nav">
				...
				<ul>
					...
					<li class="current"><a href="index.php?c=User&p=register">cadastre-se</a></li>
					<?php
					if (!empty($_SESSION['login_user'])) {
						echo '<li class="current"><a style="margin-right:80px;" href="index.php?c=User&p=logout">LOGOUT</a></li>';
					} else {
						echo '<li class="current"><a style="margin-right:80px;" href="index.php?c=User&p=login">LOGIN</a></li>';
					}
					?>
				</ul>
